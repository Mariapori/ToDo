        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kuvaus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Luoja = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Luotu = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedTodoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Muokattu = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Luotu = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Luoja = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Personal = table.Column<bool>(type: "bit", nullable: false),
                    Muokkaaja = table.Column<string>(type: "nvarchar(max)", nullable: true),
